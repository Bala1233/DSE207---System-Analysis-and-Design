$(function () {
    ...
    $("#activeSelectedProduct").click(function () {
        ...
        $.each($(".selectBox:checked"), function () {
            ...
            ProductRow.find("input.flexCheckCheckedDisabled").prop("checked", true)
            // CSS
        ...
        // db.saveChange();
        // return Json("");        
        $.post("/AdminFunction/MultiActiveSeller", { ProductIdArray: ProductIdArray });
    ...
    $("#disabledSelectedProduct").click(function () {
        ...
        $.each($(".selectBox:checked"), function () {
            ...
            ProductIdArray.push($(this).val())
            var ProductRow = $(this).parents("tr")
            ProductRow.find("input.flexCheckCheckedDisabled").prop("checked",false)
       // CSS
        ...
        // db.saveChange();
        // return Json("");
        $.post("/AdminFunction/MultiDisabledSeller", { ProductIdArray: ProductIdArray });
    })
    ...
    $("#deleteSelectedProduct").click(function () {
        ...
        console.log(ProductIdArray)
        $.post("/AdminFunction/MultiDeleteSeller", { ProductIdArray: ProductIdArray });
    })
})
